...
set size 2.500000,0.100000;  
set origin -0.15, 1.18;
# set origin -1.550,0.62;

set key center top horizontal samplen 2 font "Helvetica, 24"
...
plot ARG1 using ($1+0.75):4:(1.5) title 'EAR-Oracle' lt 1 with boxes fs pattern 3, \
ARG1 using ($1-0.75):3:(1.5) title 'SE-Oracle' lt 1 with boxes fs pattern 5
...
plot ARG1 using ($1+0.75):6:(1.5) title 'EAR-Oracle' lt 1 with boxes fs pattern 3, \
ARG1 using ($1-0.75):5:(1.5) title 'SE-Oracle' lt 1 with boxes fs pattern 5
...
plot ARG1 using ($2 - 1.5):7:(1.5) title 'FS' lt 1 with boxes fs solid 0.25, \
ARG1 using ($2):8:(1.5) title 'US' lt 1 with boxes fs solid 0.6, \
...
set ytics ("0.000" 0.0, "0.006" 0.006, "0.012" 0.012, "0.018" 0.018, "0.024" 0.024, "0.030" 0.030)
...
plot ARG1 using ($2-0.75):13:(1.5) title 'US' lt 1 with boxes fs solid 0.6, \
ARG1 using ($2 + 2.25):16:(1.5) title 'EAR-Oracle' lt 1 with boxes fs pattern 3, \
ARG1 using ($2 + 0.75):15:(1.5) title 'SE-Oracle' lt 1 with boxes fs pattern 5
# plot ARG1 using ($2 - 1.5):12:(1.5) title 'FS' lt 1 with boxes fs solid 0.25, \
