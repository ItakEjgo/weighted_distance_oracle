...
set size 5.150000,0.100000;  
set origin -0.150,0.62;
...
set yrange [10: 10000]
set label 11 center at graph 0.5,char 1 "(a) Building Time" 
set bmargin 5
set format x "%g"
set format y "10^{%T}"
...
set label 11 center at graph 0.5,char 1 "(b) Space Consumption" 
set bmargin 5
set format x "%g"
#set format y "10^{%T}"
