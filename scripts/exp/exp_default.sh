...
for file in `ls $datasets_dir`; do
    ...
    ./main --input=$datasets_dir/$file --output=$output_dir/$file-$algorithm-default.log --method=$algorithm --grid-num=$gridnum
    python3 $cleaner $output_dir/$file-$algorithm-default.log 
